...
{
    public partial class PurchaseOrderHeaderPurchaseOrderDetailTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrderHeaders_Currencies_BaseCurrencyId",
                        column: x => x.BaseCurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderHeaders_Currencies_PoCurrencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceInBaseCurrency = table.Column<decimal>(type: "smallmoney", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrderDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderDetails_Products_ProductCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderDetails_ProductCode",
                table: "PurchaseOrderDetails",
                column: "ProductCode");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderHeaders_BaseCurrencyId",
                table: "PurchaseOrderHeaders",
                column: "BaseCurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderHeaders_PoCurrencyId",
                table: "PurchaseOrderHeaders",
                column: "PoCurrencyId");
